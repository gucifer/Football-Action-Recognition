...
from rmsnet_archive.utils import nms, standard_nms
import math
from ActionSpotting import evaluate
from data.rmsnet_archive.SoccerNetClips import SoccerNetClips
from data.rmsnet_archive.pytorch_models import *
import sys
import json
import os
import errno
...
parser.add_argument("--testing_split", default='valid', type=str,
...
def main_worker(gpu, args):
    ...
    model = AlphaModel(args.num_classes).to(device)

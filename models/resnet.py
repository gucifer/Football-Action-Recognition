...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        #self.f_attention = FramewiseAttention(2048, 2048)
    ...
    def forward(self, x):
        ...
        x_event = torch.nn.functional.relu(x_features)

        x_t_shift = torch.sigmoid(self.fc_t_shift(x_event))
        x_fc = self.fc_class(x_event)

        return x_fc, x_t_shift
